            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800 mx-auto">
                ...
                <form onSubmit={handleSubmit} noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="name" id="name" placeholder="Name" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-pink-600" required />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="username" className="block text-gray-600">Email</label>
                        <input type="email" name="email" id="email" placeholder="Email" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-pink-600" required />
                    </div>
                    <div className="space-y-1 text-sm">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <div className="flex relative items-center">
                            <input type={showPassword ? "text" : "password"} name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-pink-600" required />
                            <GoEye onClick={() => setShowPassword(!showPassword)} className="absolute text-xl right-2 text-gray-300"></GoEye>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-600">Already have an account?
                    <Link to="/login"> <button className="underline text-gray-800">Sign in</button></Link>
                </p>
            </div>
            <Toaster></Toaster>
        </div>
